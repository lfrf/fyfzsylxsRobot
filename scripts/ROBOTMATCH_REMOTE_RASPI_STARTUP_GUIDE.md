...
export FACE_REGISTERED_PRIORITY_MIN_SCORE=0.40
export FACE_REGISTERED_PRIORITY_MARGIN=0.035
export FACE_UNKNOWN_CONFIRM_OBSERVATIONS=2
export FACE_AUTO_MERGE_ENABLED=true
export FACE_AUTO_MERGE_MARGIN=0.05
export VISION_WARMUP_ENABLED=false
export FER_WARMUP_ENABLED=false
...
export ROBOT_OUTPUT_CONTROL_ENABLED=true
export ROBOT_CARE_STRATEGY_ENABLED=true
export ROBOT_REPLY_HISTORY_SIZE=5
export ROBOT_CARE_RAG_MAX_CHARS=800
export ROBOT_CARE_RAG_STRUCTURED_GUIDANCE=true
export ROBOT_MEMORY_QUALITY_ENABLED=true
export ROBOT_PROFILE_CONTEXT_COMPOSER_ENABLED=true
export ROBOT_PROFILE_CONTEXT_MAX_CHARS=800
export ROBOT_CARE_MAX_CHARS=160
export ROBOT_ACCOMPANY_MAX_CHARS=160
export ROBOT_LEARNING_MAX_CHARS=240
export ROBOT_GAME_MAX_CHARS=160
...
export ROBOT_AUDIO_CAPTURE_RETRY_COUNT=2
export ROBOT_AUDIO_CAPTURE_RETRY_COOLDOWN_MS=700
export ROBOT_VAD_DYNAMIC_NOISE_ENABLED=true
export ROBOT_VAD_DYNAMIC_NOISE_CALIBRATION_MS=500
export ROBOT_VAD_DYNAMIC_NOISE_RATIO=2.2
export ROBOT_VAD_POST_PLAYBACK_STRICT_MS=2500
export ROBOT_VAD_POST_PLAYBACK_RMS_THRESHOLD=1400
export ROBOT_VAD_POST_PLAYBACK_SPEECH_START_FRAMES=10
export ROBOT_AUDIO_WEAK_SPEECH_DROP_ENABLED=true
export ROBOT_AUDIO_WEAK_SPEECH_MIN_RATIO=0.18
export ROBOT_AUDIO_WEAK_SPEECH_MIN_MEAN_RMS=900
export ROBOT_AUDIO_WEAK_SPEECH_SHORT_TOKENS='嗯,啊,呃,哦,额'
export ROBOT_AUDIO_DROP_INVALID_UTTERANCE=true
export ROBOT_AUDIO_DROP_REASONS=no_speech_detected,speech_too_short

export ROBOT_VISION_QUERY_MODE=latest
export ROBOT_VISION_LATEST_WINDOW_MS=6000
export ROBOT_VISION_LATEST_MAX_FRAMES=10
export ROBOT_VISION_PREPARE_MAX_FRAME_AGE_MS=3000
export ROBOT_VISION_PREPARE_MIN_FRAMES=2
